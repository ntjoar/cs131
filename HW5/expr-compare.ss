...
; compare the two lambda functions
...
; Test case testing
(define test-expr-x '(+ 3 ((lambda (a b) (+ a b)) 4 ((λ (c) (* 3 c)) 2))))
(define test-expr-y '(+ 3 ((λ (x y) (+ x y)) 4 ((lambda (c) (* c 3)) 2))))
